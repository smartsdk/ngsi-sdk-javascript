...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/OpqueryEntities'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./OpqueryEntities'));
  } else {
    // Browser globals (root is window)
    if (!root.NgsiV2) {
      root.NgsiV2 = {};
    }
    root.NgsiV2.Query = factory(root.NgsiV2.ApiClient, root.NgsiV2.OpqueryEntities);
  }
}(this, function(ApiClient, OpqueryEntities) {
  'use strict';
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('entities')) {
        obj['entities'] = ApiClient.convertToType(data['entities'], [OpqueryEntities]);
      }
  ...
  /**
   * @member {Array.<module:model/OpqueryEntities>} entities
   */
