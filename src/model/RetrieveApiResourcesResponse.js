...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.NgsiV2ExtensionTimeseries.RetrieveApiResourcesResponse = factory(root.NgsiV2ExtensionTimeseries.ApiClient);
  }
  ...
  /**
   * The RetrieveApiResourcesResponse model module.
   * @module model/RetrieveApiResourcesResponse
   * @version v2
   */

  /**
   * Constructs a new <code>RetrieveApiResourcesResponse</code>.
   * @alias module:model/RetrieveApiResourcesResponse
   * @class
  ...
  /**
   * Constructs a <code>RetrieveApiResourcesResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/RetrieveApiResourcesResponse} obj Optional instance to populate.
   * @return {module:model/RetrieveApiResourcesResponse} The populated <code>RetrieveApiResourcesResponse</code> instance.
   */
