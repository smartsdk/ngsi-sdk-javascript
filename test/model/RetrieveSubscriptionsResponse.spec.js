...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NgsiV2.RetrieveSubscriptionsResponse();
  });
  ...
  describe('RetrieveSubscriptionsResponse', function() {
    it('should create an instance of RetrieveSubscriptionsResponse', function() {
      ...
      //var instane = new NgsiV2.RetrieveSubscriptionsResponse();
      //expect(instance).to.be.a(NgsiV2.RetrieveSubscriptionsResponse);
    });
