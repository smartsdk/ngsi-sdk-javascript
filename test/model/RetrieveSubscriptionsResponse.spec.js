...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NgsiV2ExtensionTimeseries.RetrieveSubscriptionsResponse();
  });
  ...
  describe('RetrieveSubscriptionsResponse', function() {
    it('should create an instance of RetrieveSubscriptionsResponse', function() {
      // uncomment below and update the code to test RetrieveSubscriptionsResponse
      //var instane = new NgsiV2ExtensionTimeseries.RetrieveSubscriptionsResponse();
      //expect(instance).to.be.a(NgsiV2ExtensionTimeseries.RetrieveSubscriptionsResponse);
    });
