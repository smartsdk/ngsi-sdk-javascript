...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NgsiV2.SubscriptionSubject();
  });
  ...
  describe('SubscriptionSubject', function() {
    it('should create an instance of SubscriptionSubject', function() {
      // uncomment below and update the code to test SubscriptionSubject
      //var instane = new NgsiV2.SubscriptionSubject();
      //expect(instance).to.be.a(NgsiV2.SubscriptionSubject);
    });
