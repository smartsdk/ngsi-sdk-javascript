...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NgsiV2ExtensionTimeseries.UpdateRequest();
  });
  ...
  describe('UpdateRequest', function() {
    it('should create an instance of UpdateRequest', function() {
      ...
      //var instane = new NgsiV2ExtensionTimeseries.UpdateRequest();
      //expect(instance).to.be.a(NgsiV2ExtensionTimeseries.UpdateRequest);
    });
