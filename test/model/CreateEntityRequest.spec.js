...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NgsiV2ExtensionTimeseries.CreateEntityRequest();
  });
  ...
  describe('CreateEntityRequest', function() {
    it('should create an instance of CreateEntityRequest', function() {
      // uncomment below and update the code to test CreateEntityRequest
      //var instane = new NgsiV2ExtensionTimeseries.CreateEntityRequest();
      //expect(instance).to.be.a(NgsiV2ExtensionTimeseries.CreateEntityRequest);
    });
