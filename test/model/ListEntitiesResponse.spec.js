...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NgsiV2ExtensionTimeseries.ListEntitiesResponse();
  });
  ...
  describe('ListEntitiesResponse', function() {
    it('should create an instance of ListEntitiesResponse', function() {
      ...
      //var instane = new NgsiV2ExtensionTimeseries.ListEntitiesResponse();
      //expect(instance).to.be.a(NgsiV2ExtensionTimeseries.ListEntitiesResponse);
    });
