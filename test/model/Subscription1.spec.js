...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NgsiV2.Subscription1();
  });
  ...
  describe('Subscription1', function() {
    it('should create an instance of Subscription1', function() {
      // uncomment below and update the code to test Subscription1
      //var instane = new NgsiV2.Subscription1();
      //expect(instance).to.be.a(NgsiV2.Subscription1);
    });
