...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NgsiV2.Subscription2();
  });
  ...
  describe('Subscription2', function() {
    it('should create an instance of Subscription2', function() {
      // uncomment below and update the code to test Subscription2
      //var instane = new NgsiV2.Subscription2();
      //expect(instance).to.be.a(NgsiV2.Subscription2);
    });
